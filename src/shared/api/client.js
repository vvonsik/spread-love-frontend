...
const handleErrorCode = async (errorCode, request, options) => {
  switch (errorCode) {
    case ERROR_CODE.AUTH_GUEST_TOKEN_EXPIRED:
    case ERROR_CODE.AUTH_GUEST_TOKEN_INVALID:
    case ERROR_CODE.AUTH_TOKEN_REQUIRED: {
    ...
    case ERROR_CODE.AUTH_USER_TOKEN_EXPIRED: {
    ...
    case ERROR_CODE.AUTH_USER_TOKEN_INVALID:
    case ERROR_CODE.AUTH_TOKEN_TYPE_UNKNOWN: {
